...
float4 main(
  ...
  float _454 = (cb0_041x) * -2.0f;
  float _461 = saturate((((abs((((TEXCOORD.x) * 2.0f) + -1.0f))) + -1.0f) / (_454 * ((abs((ddy_coarse((TEXCOORD.x))))) + (abs((ddx_coarse((TEXCOORD.x)))))))));
  float _462 = saturate((((abs((((TEXCOORD.y) * 2.0f) + -1.0f))) + -1.0f) / (_454 * ((abs((ddy_coarse((TEXCOORD.y))))) + (abs((ddx_coarse((TEXCOORD.y)))))))));
  float _488 = _461 * _462;
  float _498 = (cb0_023x) * (((((_413 * ((((((_355.x) - _359) * (cb0_014w)) + _359) * (cb0_015y)) + ((_372 * (cb0_015x)) * ((((_323.x) - _332) * (cb0_014w)) + _332)))) + _372) - _404) * _240) + _404);
  float _499 = (cb0_023y) * (((((_413 * ((((((_355.y) - _360) * (cb0_014w)) + _360) * (cb0_015y)) + ((_373 * (cb0_015x)) * ((((_323.y) - _333) * (cb0_014w)) + _333)))) + _373) - _407) * _240) + _407);
  float _500 = (cb0_023z) * (((((_413 * ((((((_355.z) - _361) * (cb0_014w)) + _361) * (cb0_015y)) + ((_374 * (cb0_015x)) * ((((_323.z) - _334) * (cb0_014w)) + _334)))) + _374) - _410) * _240) + _410);
  int _504 = int(504);
  float _506 = (((bool)((_504 == 1))) ? 1.0f : 0.0f);
  float _508 = (((bool)((_504 == 2))) ? 1.0f : 0.0f);
  float _510 = (((bool)((_504 == 3))) ? 1.0f : 0.0f);
  float _512 = (((bool)((_504 == 0))) ? 0.0f : 0.8999999761581421f);
  float _519 = (_512 * 0.1120000034570694f) + 1.0f;
  float _525 = (((((bool)((_512 > 0.0f))) ? 0.10999999940395355f : 0.0f)) - (_512 * 0.07500000298023224f)) + 0.5f;
  float _526 = _525 + (_519 * (_498 + -0.5f));
  float _527 = _525 + (_519 * (_499 + -0.5f));
  float _528 = _525 + (_519 * (_500 + -0.5f));
  float _533 = ((_526 * 17.882400512695312f) + (_527 * 43.5161018371582f)) + (_528 * 4.119349956512451f);
  float _538 = ((_526 * 3.4556500911712646f) + (_527 * 27.155399322509766f)) + (_528 * 3.867140054702759f);
  float _543 = ((_526 * 0.029956599697470665f) + (_527 * 0.1843090057373047f)) + (_528 * 1.4670900106430054f);
  float _550 = (((_538 * 2.023439884185791f) - (_543 * 2.52810001373291f)) * _506) + (_533 * (1.0f - _506));
  float _557 = (((_533 * 0.4942069947719574f) + (_543 * 1.248270034790039f)) * _508) + (_538 * (1.0f - _508));
  float _564 = (((_538 * 0.8011090159416199f) - (_533 * 0.3959130048751831f)) * _510) + (_543 * (1.0f - _510));
  float _577 = ((((_557 * 0.13050441443920135f) + _526) - (_550 * 0.08094444870948792f)) - (_564 * 0.11672106385231018f)) * 0.699999988079071f;
  float _597 = 1.0f - _512;
  SV_Target.x = ((((((min((max(_526, 0.0f)), 1.0f)) * _512) - _498) + (_526 * _597)) * (cb0_083y)) + _498);
  SV_Target.y = ((((((min((max((((((_527 * 2.0f) - (_557 * 0.05401932820677757f)) + (_550 * 0.010248533450067043f)) + (_564 * 0.11361470818519592f)) + _577), 0.0f)), 1.0f)) * _512) - _499) + (_527 * _597)) * (cb0_083y)) + _499);
  SV_Target.z = ((((((min((max((((((_550 * 0.0003652969317045063f) + (_528 * 2.0f)) + (_557 * 0.004121614620089531f)) - (_564 * 0.693511426448822f)) + _577), 0.0f)), 1.0f)) * _512) - _500) + (_528 * _597)) * (cb0_083y)) + _500);
  SV_Target.w = (((((3.0f - (_461 * 2.0f)) * (max(((((_391.w) * (COLOR.w)) * (cb0_042x)) * (cb0_047w)), _240))) * (3.0f - (_462 * 2.0f))) * (_488 * _488)) * ((cb0_027x) - ((cb0_027y) * (saturate(((((saturate(((cb0_025x) * 0.5f))) - (abs((((1.0f - (TEXCOORD.w)) * 0.5f) - (cb0_024x))))) + (cb0_026x)) / (cb0_026x)))))));
