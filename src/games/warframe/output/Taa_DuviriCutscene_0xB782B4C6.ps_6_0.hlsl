...
float4 main(
  ...
  float _278 = exp2(log2((((((((_233.x * 0.800000011920929f) + ((_219.x + _208.x) * 0.10000000149011612f)) * TEXCOORD_1.w) - _200) * _208.w) + _200) + (cb0_001x * _255.x)) * 0.009999999776482582f) * 0.1593017578125f);
  float _279 = exp2(log2(((((((((_219.y * 0.699999988079071f) + (_208.y * 0.20000000298023224f)) + (_233.y * 0.10000000149011612f)) * TEXCOORD_1.w) - _201) * _208.w) + _201) + (cb0_001y * _255.y)) * 0.009999999776482582f) * 0.1593017578125f);
  float _280 = exp2(log2(((((((((_219.z * 0.20000000298023224f) + (_208.z * 0.10000000149011612f)) + (_233.z * 0.699999988079071f)) * TEXCOORD_1.w) - _202) * _208.w) + _202) + (cb0_001z * _255.z)) * 0.009999999776482582f) * 0.1593017578125f);
  ...
  SV_Target.rgb = BlendUI(_524, float3(_521, _522, _523));
  SV_Target.w = _315;
  return SV_Target;
}
