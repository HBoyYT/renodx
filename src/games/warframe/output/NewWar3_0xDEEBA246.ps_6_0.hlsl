...
float4 main(
  ...
  float _301 = exp2(log2(((saturate(cb0_001x + _273) * ((_262.x * 0.20000000298023224f) - _259)) + _259) * 0.009999999776482582f) * 0.1593017578125f);
  float _302 = exp2(log2(((saturate(cb0_001y + _273) * ((_262.y * 0.20000000298023224f) - _260)) + _260) * 0.009999999776482582f) * 0.1593017578125f);
  float _303 = exp2(log2(((saturate(cb0_001z + _273) * ((_262.z * 0.20000000298023224f) - _261)) + _261) * 0.009999999776482582f) * 0.1593017578125f);
  ...
  float _574;
  [branch]
  if ((!(_416.w < 9.999999747378752e-05f)) && (RENODX_FX_ENABLE_UI == 1.f)) {    
    ...
    if (RENODX_TONE_MAP_TYPE == 0.f) {
      ...
      _464 = mad(-0.07283999770879745f, _461, mad(-0.5876560211181641f, _460, (_459 * 1.6604959964752197f)));
      _467 = mad(-0.00834800023585558f, _461, mad(1.1328949928283691f, _460, (_459 * -0.12454699724912643f)));
      _470 = mad(1.118751049041748f, _461, mad(-0.10059700161218643f, _460, (_459 * -0.018154000863432884f)));
    } else {
      float3 color = float3(_413, _414, _415);
    ...
    if (RENODX_TONE_MAP_TYPE == 0.f) {
      ...
      float3 color = float3(_523, _524, _525);
