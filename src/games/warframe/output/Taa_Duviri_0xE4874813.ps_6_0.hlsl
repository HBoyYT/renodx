...
float4 main(
  ...
  float _310 = exp2(log2(((((_245.x * 0.20000000298023224f) - _272) * saturate(cb0_001x + _282)) + _272) * 0.009999999776482582f) * 0.1593017578125f);
  float _311 = exp2(log2(((saturate(cb0_001y + _282) * ((_245.y * 0.20000000298023224f) - _273)) + _273) * 0.009999999776482582f) * 0.1593017578125f);
  float _312 = exp2(log2(((saturate(cb0_001z + _282) * ((_245.z * 0.20000000298023224f) - _274)) + _274) * 0.009999999776482582f) * 0.1593017578125f);
  ...
  SV_Target.rgb = BlendUI(_510, float3(_507, _508, _509));
  SV_Target.w = _347;
  return SV_Target;
}
