...
float4 main(
  ...
  float _372 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _344) * ((_333.x * 0.20000000298023224f) - _330)) + _330) * 0.009999999776482582f) * 0.1593017578125f);
  float _373 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _344) * ((_333.y * 0.20000000298023224f) - _331)) + _331) * 0.009999999776482582f) * 0.1593017578125f);
  float _374 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _344) * ((_333.z * 0.20000000298023224f) - _332)) + _332) * 0.009999999776482582f) * 0.1593017578125f);
