...
float4 main(
  ...
  float _457 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _429) * ((_418.x * 0.20000000298023224f) - _415)) + _415) * 0.009999999776482582f) * 0.1593017578125f);
  float _458 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _429) * ((_418.y * 0.20000000298023224f) - _416)) + _416) * 0.009999999776482582f) * 0.1593017578125f);
  float _459 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _429) * ((_418.z * 0.20000000298023224f) - _417)) + _417) * 0.009999999776482582f) * 0.1593017578125f);
  ...
  SV_Target.rgb = BlendUI(_572, ApplyDitheringAndFilmGrain(_490.rgb, float3(_550, _551, _552), _565, TEXCOORD.xy));
  SV_Target.w = _494;
  return SV_Target;
}
