...
float4 main(
  ...
  float _72 = sqrt((_67 * _67) + (_68 * _68)) * RENODX_FX_VIGNETTE_STRENGTH;
  ...
  float _203 = exp2(log2(((saturate(cb0_001x + _175) * ((_164.x * 0.20000000298023224f) - _159)) + _159) * 0.009999999776482582f) * 0.1593017578125f);
  float _204 = exp2(log2(((saturate(cb0_001y + _175) * ((_164.y * 0.20000000298023224f) - _161)) + _161) * 0.009999999776482582f) * 0.1593017578125f);
  float _205 = exp2(log2(((saturate(cb0_001z + _175) * ((_164.z * 0.20000000298023224f) - _163)) + _163) * 0.009999999776482582f) * 0.1593017578125f);
  ...
  float _476;
  [branch]
  if ((!(_318.w < 9.999999747378752e-05f)) && (RENODX_FX_ENABLE_UI == 1.f)) {
    ...
    if (RENODX_TONE_MAP_TYPE == 0.f) {
      ...
      _366 = mad(-0.07283999770879745f, _363, mad(-0.5876560211181641f, _362, (_361 * 1.6604959964752197f)));
      _369 = mad(-0.00834800023585558f, _363, mad(1.1328949928283691f, _362, (_361 * -0.12454699724912643f)));
      _372 = mad(1.118751049041748f, _363, mad(-0.10059700161218643f, _362, (_361 * -0.018154000863432884f)));
    } else {
      float3 color = float3(_315, _316, _317);
    ...
    if (RENODX_TONE_MAP_TYPE == 0.f) {
      ...
      float3 color = float3(_425, _426, _427);
