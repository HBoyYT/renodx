...
float4 main(
  ...
  float _226 = ((((((_207.x) * 0.800000011920929f) + (((_193.x) + (_182.x)) * 0.10000000149011612f)) * (TEXCOORD_1.w)) - _174) * (_182.w)) + _174;
  float _227 = (((((((_193.y) * 0.699999988079071f) + ((_182.y) * 0.20000000298023224f)) + ((_207.y) * 0.10000000149011612f)) * (TEXCOORD_1.w)) - _175) * (_182.w)) + _175;
  float _228 = (((((((_193.z) * 0.20000000298023224f) + ((_182.z) * 0.10000000149011612f)) + ((_207.z) * 0.699999988079071f)) * (TEXCOORD_1.w)) - _176) * (_182.w)) + _176;
  float4 _229 = t1.SampleLevel(s1, float2(_180, _181), 0.0f);
  float _240 = (saturate(((((cb0_000w) / ((((float4)(t4.SampleLevel(s4, float2((min(_25, (cb0_009x))), (min(_26, (cb0_009y)))), 0.0f))).x) - (cb0_000z))) + -500.0f) * 0.0020000000949949026f))) * 0.22499999403953552f;
  float4 _280 = t3.Sample(s3, float3((((saturate((((log2(((_226 + 0.002667719265446067f) + ((saturate(((cb0_001x) + _240))) * (((_229.x) * 0.20000000298023224f) - _226))))) * 0.0714285746216774f) + 0.6107269525527954f))) * 0.96875f) + 0.015625f), (((saturate((((log2(((_227 + 0.002667719265446067f) + ((saturate(((cb0_001y) + _240))) * (((_229.y) * 0.20000000298023224f) - _227))))) * 0.0714285746216774f) + 0.6107269525527954f))) * 0.96875f) + 0.015625f), (((saturate((((log2(((_228 + 0.002667719265446067f) + ((saturate(((cb0_001z) + _240))) * (((_229.z) * 0.20000000298023224f) - _228))))) * 0.0714285746216774f) + 0.6107269525527954f))) * 0.96875f) + 0.015625f)));
  float _284 = dot(float3((_280.x), (_280.y), (_280.z)), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
  float _287 = (cb0_003x) * 0.0009765625f;
  float _291 = frac((abs(_287)));
  float _297 = frac(((TEXCOORD.x) * 5.39870023727417f));
  float _298 = frac(((TEXCOORD.y) * 5.4421000480651855f));
  float _299 = frac((((((bool)((_287 >= (-0.0f - _287)))) ? _291 : (-0.0f - _291))) * 7103.59033203125f));
  float _303 = dot(float3(_298, _299, _297), float3((_297 + 21.53510093688965f), (_298 + 14.313699722290039f), (_299 + 15.324700355529785f)));
  float _304 = _303 + _297;
  float _305 = _303 + _298;
  float _306 = _303 + _299;
  float _307 = _304 * _305;
  float _319 = (frac((_307 * 97.59010314941406f))) + -0.5f;
  float _320 = (frac(((_306 * 93.83689880371094f) * _304))) + -0.5f;
  float _321 = (frac(((_306 * 91.69309997558594f) * _305))) + -0.5f;
  float _340 = ((frac((_307 * 95.43070220947266f))) + -0.5f) + ((((((bool)(((_280.x) < 0.0019607844296842813f))) ? 0.0f : 1.0f)) * ((((bool)(((_280.x) > 0.998039186000824f))) ? 0.0f : 1.0f))) * _319);
  float _341 = ((((((bool)(((_280.y) < 0.0019607844296842813f))) ? 0.0f : 1.0f)) * ((((bool)(((_280.y) > 0.998039186000824f))) ? 0.0f : 1.0f))) * _320) + _319;
  float _342 = ((((((bool)(((_280.z) < 0.0019607844296842813f))) ? 0.0f : 1.0f)) * ((((bool)(((_280.z) > 0.998039186000824f))) ? 0.0f : 1.0f))) * _321) + _320;
  float _355 = ((saturate((1.0f - _284))) * (dot(float4(_340, _341, _342, _321), float4(0.3333333432674408f, 0.3333333432674408f, 0.3333333432674408f, 0.3333333432674408f)))) * (cb0_015x);
  SV_Target.x = ((((RENODX_FX_DITHERING_STRENGTH * ((_340) * 0.003921568859368563f) + (_280.x)) + _355)));
  SV_Target.y = ((((RENODX_FX_DITHERING_STRENGTH * ((_341) * 0.003921568859368563f) + (_280.y)) + _355)));
  SV_Target.z = ((((RENODX_FX_DITHERING_STRENGTH * ((_342) * 0.003921568859368563f) + (_280.z)) + _355)));
  SV_Target.w = _284;
