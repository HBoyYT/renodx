...
float4 main(
  ...
  float _282 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _254) * ((_243.x * 0.20000000298023224f) - _240)) + _240) * 0.009999999776482582f) * 0.1593017578125f);
  float _283 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _254) * ((_243.y * 0.20000000298023224f) - _241)) + _241) * 0.009999999776482582f) * 0.1593017578125f);
  float _284 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _254) * ((_243.z * 0.20000000298023224f) - _242)) + _242) * 0.009999999776482582f) * 0.1593017578125f);
