...
float4 main(
  ...
  float _284 = exp2(log2(((saturate(cb0_001x + _256) * ((_245.x * 0.20000000298023224f) - _242)) + _242) * 0.009999999776482582f) * 0.1593017578125f);
  float _285 = exp2(log2(((saturate(cb0_001y + _256) * ((_245.y * 0.20000000298023224f) - _243)) + _243) * 0.009999999776482582f) * 0.1593017578125f);
  float _286 = exp2(log2(((saturate(cb0_001z + _256) * ((_245.z * 0.20000000298023224f) - _244)) + _244) * 0.009999999776482582f) * 0.1593017578125f);
  ...
  SV_Target.rgb = BlendUI(_399, float3(_396, _397, _398));
  SV_Target.w = _321;
  return SV_Target;
}
