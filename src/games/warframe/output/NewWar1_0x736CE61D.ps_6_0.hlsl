...
float4 main(
  ...
  float _215 = exp2(log2(((saturate(cb0_001x + _187) * ((_176.x * 0.20000000298023224f) - _173)) + _173) * 0.009999999776482582f) * 0.1593017578125f);
  float _216 = exp2(log2(((saturate(cb0_001y + _187) * ((_176.y * 0.20000000298023224f) - _174)) + _174) * 0.009999999776482582f) * 0.1593017578125f);
  float _217 = exp2(log2(((saturate(cb0_001z + _187) * ((_176.z * 0.20000000298023224f) - _175)) + _175) * 0.009999999776482582f) * 0.1593017578125f);
  ...
  float _488;
  [branch]
  if ((!(_330.w < 9.999999747378752e-05f)) && (RENODX_FX_ENABLE_UI == 1.f)) {
    ...
    if (RENODX_TONE_MAP_TYPE == 0.f) {
      ...
      _378 = mad(-0.07283999770879745f, _375, mad(-0.5876560211181641f, _374, (_373 * 1.6604959964752197f)));
      _381 = mad(-0.00834800023585558f, _375, mad(1.1328949928283691f, _374, (_373 * -0.12454699724912643f)));
      _384 = mad(1.118751049041748f, _375, mad(-0.10059700161218643f, _374, (_373 * -0.018154000863432884f)));
    } else {
      float3 color = float3(_327, _328, _329);
    ...
    if (RENODX_TONE_MAP_TYPE == 0.f) {
      ...
      float3 color = float3(_437, _438, _439);
