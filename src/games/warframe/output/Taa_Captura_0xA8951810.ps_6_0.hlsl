...
float4 main(
  ...
  float _270 = (saturate(shader_injection.fx_bloom_strength + _254) * ((_243.x * 0.20000000298023224f) - _240)) + _240;
  float _271 = (saturate(shader_injection.fx_bloom_strength + _254) * ((_243.y * 0.20000000298023224f) - _241)) + _241;
  float _272 = (saturate(shader_injection.fx_bloom_strength + _254) * ((_243.z * 0.20000000298023224f) - _242)) + _242;
