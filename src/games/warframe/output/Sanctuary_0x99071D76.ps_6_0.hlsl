...
float4 main(
  ...
  float _250 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _222) * ((_211.x * 0.20000000298023224f) - _208)) + _208) * 0.009999999776482582f) * 0.1593017578125f);
  float _251 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _222) * ((_211.y * 0.20000000298023224f) - _209)) + _209) * 0.009999999776482582f) * 0.1593017578125f);
  float _252 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _222) * ((_211.z * 0.20000000298023224f) - _210)) + _210) * 0.009999999776482582f) * 0.1593017578125f);
