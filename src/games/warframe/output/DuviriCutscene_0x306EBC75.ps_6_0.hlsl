...
float4 main(
  ...
  float _211 = exp2(log2(((shader_injection.fx_bloom_strength * _182.x) + (((((((_152.x + _141.x) * 0.10000000149011612f) - _133) + (_164.x * 0.800000011920929f)) * _141.w) + _133) * TEXCOORD_1.w)) * 0.009999999776482582f) * 0.1593017578125f);
  float _212 = exp2(log2(((shader_injection.fx_bloom_strength * _182.y) + (((((((_141.y * 0.20000000298023224f) - _134) + (_152.y * 0.699999988079071f)) + (_164.y * 0.10000000149011612f)) * _141.w) + _134) * TEXCOORD_1.w)) * 0.009999999776482582f) * 0.1593017578125f);
  float _213 = exp2(log2(((shader_injection.fx_bloom_strength * _182.z) + (((((((_141.z * 0.10000000149011612f) - _135) + (_152.z * 0.20000000298023224f)) + (_164.z * 0.699999988079071f)) * _141.w) + _135) * TEXCOORD_1.w)) * 0.009999999776482582f) * 0.1593017578125f);
  ...
  // float _615;
  // [branch]
  // if (!(_457.w < 9.999999747378752e-05f)) {
  ...
  //   float _505 = mad(-0.07283999770879745f, _502, mad(-0.5876560211181641f, _501, (_500 * 1.6604959964752197f)));
  //   float _508 = mad(-0.00834800023585558f, _502, mad(1.1328949928283691f, _501, (_500 * -0.12454699724912643f)));
  //   float _511 = mad(1.118751049041748f, _502, mad(-0.10059700161218643f, _501, (_500 * -0.018154000863432884f)));
  ...
  SV_Target.rgb = BlendUI(_457, ApplyDitheringAndFilmGrain(float3(_379, _380, _381), float3(_435, _436, _437), _450, TEXCOORD.xy));
  SV_Target.w = _248;
  return SV_Target;
}
