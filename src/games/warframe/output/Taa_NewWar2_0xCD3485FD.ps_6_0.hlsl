...
float4 main(
  ...
  float _459 = exp2(log2(((saturate(cb0_001x + _431) * ((_420.x * 0.20000000298023224f) - _417)) + _417) * 0.009999999776482582f) * 0.1593017578125f);
  float _460 = exp2(log2(((saturate(cb0_001y + _431) * ((_420.y * 0.20000000298023224f) - _418)) + _418) * 0.009999999776482582f) * 0.1593017578125f);
  float _461 = exp2(log2(((saturate(cb0_001z + _431) * ((_420.z * 0.20000000298023224f) - _419)) + _419) * 0.009999999776482582f) * 0.1593017578125f);
