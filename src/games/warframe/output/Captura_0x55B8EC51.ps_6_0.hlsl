...
float4 main(
  ...
  float _201 = (saturate(shader_injection.fx_bloom_strength + _185) * ((_174.x * 0.20000000298023224f) - _171)) + _171;
  float _202 = (saturate(shader_injection.fx_bloom_strength + _185) * ((_174.y * 0.20000000298023224f) - _172)) + _172;
  float _203 = (saturate(shader_injection.fx_bloom_strength + _185) * ((_174.z * 0.20000000298023224f) - _173)) + _173;
