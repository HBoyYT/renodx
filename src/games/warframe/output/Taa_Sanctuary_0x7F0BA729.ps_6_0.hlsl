...
float4 main(
  ...
  float _319 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _291) * ((_280.x * 0.20000000298023224f) - _277)) + _277) * 0.009999999776482582f) * 0.1593017578125f);
  float _320 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _291) * ((_280.y * 0.20000000298023224f) - _278)) + _278) * 0.009999999776482582f) * 0.1593017578125f);
  float _321 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _291) * ((_280.z * 0.20000000298023224f) - _279)) + _279) * 0.009999999776482582f) * 0.1593017578125f);
  ...
  SV_Target.rgb = BlendUI(_434, ApplyDitheringAndFilmGrain(_352.rgb, float3(_412, _413, _414), _427, TEXCOORD.xy));
  SV_Target.w = _356;
  return SV_Target;
}
