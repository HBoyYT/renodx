...
float4 main(
  ...
  float _241 = exp2(log2(((((_176.x * 0.20000000298023224f) - _203) * saturate(cb0_001x + _213)) + _203) * 0.009999999776482582f) * 0.1593017578125f);
  float _242 = exp2(log2(((saturate(cb0_001y + _213) * ((_176.y * 0.20000000298023224f) - _204)) + _204) * 0.009999999776482582f) * 0.1593017578125f);
  float _243 = exp2(log2(((saturate(cb0_001z + _213) * ((_176.z * 0.20000000298023224f) - _205)) + _205) * 0.009999999776482582f) * 0.1593017578125f);
  ...
  float _599;
  [branch]
  if ((!(_441.w < 9.999999747378752e-05f)) && (RENODX_FX_ENABLE_UI == 1.f)) {
    ...
    if (RENODX_TONE_MAP_TYPE == 0.f) {
      ...
      _489 = mad(-0.07283999770879745f, _486, mad(-0.5876560211181641f, _485, (_484 * 1.6604959964752197f)));
      _492 = mad(-0.00834800023585558f, _486, mad(1.1328949928283691f, _485, (_484 * -0.12454699724912643f)));
      _495 = mad(1.118751049041748f, _486, mad(-0.10059700161218643f, _485, (_484 * -0.018154000863432884f)));
    } else {
      float3 color = float3(_438, _439, _440);
