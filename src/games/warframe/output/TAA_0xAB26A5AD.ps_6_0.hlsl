...
float4 main(
  ...
  float _252 = (saturate(((((cb0_000w) / ((((float4)(t4.SampleLevel(s4, float2((min(_25, (cb0_009x))), (min(_26, (cb0_009y)))), 0.0f))).x) - (cb0_000z))) + -500.0f) * 0.0020000000949949026f))) * 0.22499999403953552f;
  float4 _292 = t3.Sample(s3, float3((((saturate((((log2(((_238 + 0.002667719265446067f) + ((saturate(((cb0_001x) + _252))) * (((_241.x) * 0.20000000298023224f) - _238))))) * 0.0714285746216774f) + 0.6107269525527954f))) * 0.96875f) + 0.015625f), (((saturate((((log2(((_239 + 0.002667719265446067f) + ((saturate(((cb0_001y) + _252))) * (((_241.y) * 0.20000000298023224f) - _239))))) * 0.0714285746216774f) + 0.6107269525527954f))) * 0.96875f) + 0.015625f), (((saturate((((log2(((_240 + 0.002667719265446067f) + ((saturate(((cb0_001z) + _252))) * (((_241.z) * 0.20000000298023224f) - _240))))) * 0.0714285746216774f) + 0.6107269525527954f))) * 0.96875f) + 0.015625f)));

  float _296 = dot(float3((_292.x), (_292.y), (_292.z)), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
  float _299 = (cb0_003x) * 0.0009765625f;
  float _303 = frac((abs(_299)));
  float _309 = frac(((TEXCOORD.x) * 5.39870023727417f));
  float _310 = frac(((TEXCOORD.y) * 5.4421000480651855f));
  float _311 = frac((((((bool)((_299 >= (-0.0f - _299)))) ? _303 : (-0.0f - _303))) * 7103.59033203125f));
  float _315 = dot(float3(_310, _311, _309), float3((_309 + 21.53510093688965f), (_310 + 14.313699722290039f), (_311 + 15.324700355529785f)));
  float _316 = _315 + _309;
  float _317 = _315 + _310;
  float _318 = _315 + _311;
  float _319 = _316 * _317;
  float _331 = (frac((_319 * 97.59010314941406f))) + -0.5f;
  float _332 = (frac(((_318 * 93.83689880371094f) * _316))) + -0.5f;
  float _333 = (frac(((_318 * 91.69309997558594f) * _317))) + -0.5f;
  float _352 = ((frac((_319 * 95.43070220947266f))) + -0.5f) + ((((((bool)(((_292.x) < 0.0019607844296842813f))) ? 0.0f : 1.0f)) * ((((bool)(((_292.x) > 0.998039186000824f))) ? 0.0f : 1.0f))) * _331);
  float _353 = ((((((bool)(((_292.y) < 0.0019607844296842813f))) ? 0.0f : 1.0f)) * ((((bool)(((_292.y) > 0.998039186000824f))) ? 0.0f : 1.0f))) * _332) + _331;
  float _354 = ((((((bool)(((_292.z) < 0.0019607844296842813f))) ? 0.0f : 1.0f)) * ((((bool)(((_292.z) > 0.998039186000824f))) ? 0.0f : 1.0f))) * _333) + _332;
  float _367 = ((saturate((1.0f - _296))) * (dot(float4(_352, _353, _354, _333), float4(0.3333333432674408f, 0.3333333432674408f, 0.3333333432674408f, 0.3333333432674408f)))) * (cb0_015x);
  SV_Target.x = ((((RENODX_FX_DITHERING_STRENGTH * ((_352) * 0.003921568859368563f) + (_292.x)) + _367)));
  SV_Target.y = ((((RENODX_FX_DITHERING_STRENGTH * ((_353) * 0.003921568859368563f) + (_292.y)) + _367)));
  SV_Target.z = ((((RENODX_FX_DITHERING_STRENGTH * ((_354) * 0.003921568859368563f) + (_292.z)) + _367)));
  SV_Target.w = _296;
