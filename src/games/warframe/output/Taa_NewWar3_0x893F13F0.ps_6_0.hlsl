...
float4 main(
  ...
  float _370 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _342) * ((_331.x * 0.20000000298023224f) - _328)) + _328) * 0.009999999776482582f) * 0.1593017578125f);
  float _371 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _342) * ((_331.y * 0.20000000298023224f) - _329)) + _329) * 0.009999999776482582f) * 0.1593017578125f);
  float _372 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _342) * ((_331.z * 0.20000000298023224f) - _330)) + _330) * 0.009999999776482582f) * 0.1593017578125f);
  ...
  SV_Target.rgb = BlendUI(_485, ApplyDitheringAndFilmGrain(_403.rgb, float3(_463, _464, _465), _478, TEXCOORD.xy));
  SV_Target.w = _407;
  return SV_Target;
}
