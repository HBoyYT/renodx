...
float4 main(
  ...
  float _270 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _242) * ((_231.x * 0.20000000298023224f) - _228)) + _228) * 0.009999999776482582f) * 0.1593017578125f);
  float _271 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _242) * ((_231.y * 0.20000000298023224f) - _229)) + _229) * 0.009999999776482582f) * 0.1593017578125f);
  float _272 = exp2(log2(((saturate(shader_injection.fx_bloom_strength + _242) * ((_231.z * 0.20000000298023224f) - _230)) + _230) * 0.009999999776482582f) * 0.1593017578125f);
