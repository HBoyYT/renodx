...
float4 main(
  ...
  float _213 = exp2(log2(((saturate(cb0_001x + _185) * ((_174.x * 0.20000000298023224f) - _171)) + _171) * 0.009999999776482582f) * 0.1593017578125f);
  float _214 = exp2(log2(((saturate(cb0_001y + _185) * ((_174.y * 0.20000000298023224f) - _172)) + _172) * 0.009999999776482582f) * 0.1593017578125f);
  float _215 = exp2(log2(((saturate(cb0_001z + _185) * ((_174.z * 0.20000000298023224f) - _173)) + _173) * 0.009999999776482582f) * 0.1593017578125f);
  ...
  float _486;
  [branch]
  if ((!(_328.w < 9.999999747378752e-05f)) && (RENODX_FX_ENABLE_UI == 1.f)) {
    ...
    if (RENODX_TONE_MAP_TYPE == 0.f) {
      ...
      _376 = mad(-0.07283999770879745f, _373, mad(-0.5876560211181641f, _372, (_371 * 1.6604959964752197f)));
      _379 = mad(-0.00834800023585558f, _373, mad(1.1328949928283691f, _372, (_371 * -0.12454699724912643f)));
      _382 = mad(1.118751049041748f, _373, mad(-0.10059700161218643f, _372, (_371 * -0.018154000863432884f)));
    } else {
      float3 color = float3(_325, _326, _327);
    ...
    if (RENODX_TONE_MAP_TYPE == 0.f) {
      ...
      float3 color = float3(_435, _436, _437);
