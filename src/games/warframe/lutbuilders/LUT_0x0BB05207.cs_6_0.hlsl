...
void main(
  ...
  if (RENODX_FIX_COLOR) {
    _443 = cb0_010x * (exp2(log2(((((_303 * (((cb0_033x + cb0_018x) + _203) + (((cb0_032x * cb0_017x) * _212) * exp2(log2(exp2(((cb0_030x * cb0_015x) * _230) * log2(((((_123 * cb0_029x) * _236) + _52)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_031x * cb0_016x) * _221)))))) + (_194 * (((cb0_018x + cb0_023x) + _66) + (((cb0_017x * cb0_022x) * _80) * exp2(log2(exp2(((cb0_015x * cb0_020x) * _108) * log2(((((_123 * cb0_019x) * _119) + _52)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_016x * cb0_021x) * _94))))))) + ((((cb0_028x + cb0_018x) + _312) + (((cb0_027x * cb0_017x) * _321) * exp2(log2(exp2(((cb0_025x * cb0_015x) * _339) * log2(((((_123 * cb0_024x) * _345) + _52)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_026x * cb0_016x) * _330))))) * _403)))) * cb0_011x) + cb0_011w);
    _444 = cb0_010y * (exp2(log2(((((_303 * (((cb0_033y + cb0_018y) + _203) + (((cb0_032y * cb0_017y) * _212) * exp2(log2(exp2(((cb0_030y * cb0_015y) * _230) * log2(((((_126 * cb0_029y) * _236) + _52)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_031y * cb0_016y) * _221)))))) + (_194 * (((cb0_018y + cb0_023y) + _66) + (((cb0_017y * cb0_022y) * _80) * exp2(log2(exp2(((cb0_015y * cb0_020y) * _108) * log2(((((_126 * cb0_019y) * _119) + _52)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_016y * cb0_021y) * _94))))))) + ((((cb0_028y + cb0_018y) + _312) + (((cb0_027y * cb0_017y) * _321) * exp2(log2(exp2(((cb0_025y * cb0_015y) * _339) * log2(((((_126 * cb0_024y) * _345) + _52)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_026y * cb0_016y) * _330))))) * _403)))) * cb0_011y) + cb0_011w);
    _445 = cb0_010z * (exp2(log2(((((_303 * (((cb0_033z + cb0_018z) + _203) + (((cb0_032z * cb0_017z) * _212) * exp2(log2(exp2(((cb0_030z * cb0_015z) * _230) * log2(((((_129 * cb0_029z) * _236) + _52)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_031z * cb0_016z) * _221)))))) + (_194 * (((cb0_018z + cb0_023z) + _66) + (((cb0_017z * cb0_022z) * _80) * exp2(log2(exp2(((cb0_015z * cb0_020z) * _108) * log2(((((_129 * cb0_019z) * _119) + _52)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_016z * cb0_021z) * _94))))))) + ((((cb0_028z + cb0_018z) + _312) + (((cb0_027z * cb0_017z) * _321) * exp2(log2(exp2(((cb0_025z * cb0_015z) * _339) * log2(((((_129 * cb0_024z) * _345) + _52)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_026z * cb0_016z) * _330))))) * _403)))) * cb0_011z) + cb0_011w);
  }
  ...
  // Fix incorrect SRGB decode
  if (RENODX_FIX_COLOR) {
    float3 color = float3(_585, _586, _587);
    if (_580) {
      color = renodx::color::srgb::DecodeSafe(color);
    } else {
      color = float3(_575, _576, _577);
    }

    _655 = ((color.r) - _575) * cb0_037z;
    _656 = ((color.g) - _576) * cb0_037z;
    _657 = ((color.b) - _577) * cb0_037z;
  }
  ...
  // Fix incorrect SRGB decode
  if (RENODX_FIX_COLOR) {
    float3 color = float3(_621, _622, _623);
    if (_616) {
      color = renodx::color::srgb::DecodeSafe(color);
    } else {
      color = float3(_575, _576, _577);
    ...
    _676 = (_655 + _575) + ((((color.r  - _575) * cb0_037w) - _655) * cb0_036x);
    _677 = (_656 + _576) + ((((color.g  - _576) * cb0_037w) - _656) * cb0_036x);
    _678 = (_657 + _577) + ((((color.b  - _577) * cb0_037w) - _657) * cb0_036x);
  }
  ...
  // SRGB EncodeSafe
  if (RENODX_FIX_COLOR) {
    _743 = renodx::math::Sign(_693) * saturate(_739 + ((exp2(log2(select((abs(_693) <= 0.0031308000907301903f), (abs(_693) * 12.920000076293945f), (((pow(abs(_693), 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f))) * cb0_009x) + -0.5f) * cb0_009y));
    _744 = renodx::math::Sign(_694) * saturate(_739 + ((exp2(log2(select((abs(_694) <= 0.0031308000907301903f), (abs(_694) * 12.920000076293945f), (((pow(abs(_694), 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f))) * cb0_009x) + -0.5f) * cb0_009y));
    _745 = renodx::math::Sign(_695) * saturate(_739 + ((exp2(log2(select((abs(_695) <= 0.0031308000907301903f), (abs(_695) * 12.920000076293945f), (((pow(abs(_695), 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f))) * cb0_009x) + -0.5f) * cb0_009y));
  }
  ...
  if (RENODX_FIX_COLOR) {
    _855 = ((((min((_771), 1.0f) * _757) - _743) + (_771 * _842)) * cb0_013y) + _743;
    _856 = ((((min(((((((_772 * 2.0f) - (_802 * 0.05401932820677757f)) + (_795 * 0.010248533450067043f)) + (_809 * 0.11361470818519592f)) + _822)), 1.0f) * _757) - _744) + (_772 * _842)) * cb0_013y) + _744;
    _857 = ((((min(((((((_795 * 0.0003652969317045063f) + (_773 * 2.0f)) + (_802 * 0.004121614620089531f)) - (_809 * 0.693511426448822f)) + _822)), 1.0f) * _757) - _745) + (_773 * _842)) * cb0_013y) + _745;
  }
  ...
  // SRGB EncodeSafe
  if (RENODX_FIX_COLOR) {
    float3 color = float3(_855, _856, _857);
    color = renodx::color::srgb::DecodeSafe(color);
