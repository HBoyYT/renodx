...
float4 main(
  ...
  float _80 = sqrt((_35 * _35) + (_34 * _34));
  float _84 = (_80 * _80) * cb0_017x * RENODX_FX_CA_STRENGTH;
  ...
  if (!RENODX_FIX_COLOR) {
    ...
    _349 = select((_321 <= 0.0031308000907301903f), (_321 * 12.920000076293945f), (((pow(_321, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
    _350 = select((_324 <= 0.0031308000907301903f), (_324 * 12.920000076293945f), (((pow(_324, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
    _351 = select((_327 <= 0.0031308000907301903f), (_327 * 12.920000076293945f), (((pow(_327, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    color = renodx::color::pq::DecodeSafe(float3(_274.x, _274.y, _274.z),RENODX_DIFFUSE_WHITE_NITS);
  ...
  if (!RENODX_FIX_COLOR) {
    ...
    _484 = exp2(log2(((_460 * 18.8515625f) + 0.8359375f) / ((_460 * 18.6875f) + 1.0f)) * 78.84375f);
    _485 = exp2(log2(((_461 * 18.8515625f) + 0.8359375f) / ((_461 * 18.6875f) + 1.0f)) * 78.84375f);
    _486 = exp2(log2(((_462 * 18.8515625f) + 0.8359375f) / ((_462 * 18.6875f) + 1.0f)) * 78.84375f);
  } else {
    color = renodx::color::srgb::DecodeSafe(float3(_414, _415, _416));
  ...
  if (!RENODX_FIX_COLOR) {
    ...
    SV_Target.rgb = BlendUI(_487, float3(_484, _485, _486));
    SV_Target.rgb = BlendUI(_487, float3(_274.r, _274.g, _274.b));
