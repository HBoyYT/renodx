...
float4 main(
  ...
  // returns average image brightness
  // To increase brightness, can lerp with lower average brightness to compensate
  ...
  SV_Target = lerp(0.f, SV_Target, shader_injection.fx_autoexposre_strength);
