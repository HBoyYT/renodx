...
struct ShaderInjectData {
  ...
  float fx_autoexposure_strength;
  float fx_enable_ui;
...
#define RENODX_PER_CHANNEL_HUE_CORRECTION        shader_injection.per_channel_hue_correction        // = 0.f
#define RENODX_PER_CHANNEL_CHROMINANCE_CORRECTION shader_injection.per_channel_chrominance_correction           // = 1.f
#define RENODX_PER_CHANNEL_BLOWOUT_RESTORATION   shader_injection.per_channel_blowout_restoration
#define RENODX_PER_CHANNEL_HUE_SHIFT         shader_injection.per_channel_hue_shift
...
//#define RENODX_FX_AUTOEXPOSURE_STRENGTH         1.f
#define RENODX_FX_AUTOEXPOSURE_STRENGTH         shader_injection.fx_autoexposure_strength
...
#define RENODX_SWAP_CHAIN_ENCODING            4.f    // 0 = none, 4 = hdr10, 5 = scrgb
